      ...
      <div className="flex gap-2 border-t border-[#f4f2f0] bg-white px-4 pb-3 pt-2">
        ...
        <motion.button
          className={`flex flex-1 flex-col items-center justify-end gap-1 ${
            isActive("/") ? "text-[#181411]" : "text-[#887563]"
          }`}
        ...
        <motion.button
          className={`flex flex-1 flex-col items-center justify-end gap-1 ${
            isActive("/about") ? "text-[#181411]" : "text-[#887563]"
          }`}
        ...
        {/* Shopping Cart Tab */}
        <motion.button
          className={`flex flex-1 flex-col items-center justify-end gap-1 relative ${
            isActive("/cart") ? "text-[#181411]" : "text-[#887563]"
          }`}
        ...
        <motion.button
          className={`flex flex-1 flex-col items-center justify-end gap-1 ${
            isActive("/contact") ? "text-[#181411]" : "text-[#887563]"
          }`}
        ...
        <motion.button
          className={`flex flex-1 flex-col items-center justify-end gap-1 rounded-full ${
            isActive("/profile") ? "text-[#181411]" : "text-[#887563]"
          }`}
          onClick={() => {
            if (!session) {
